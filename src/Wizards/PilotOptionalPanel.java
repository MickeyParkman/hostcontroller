...
public class PilotOptionalPanel extends JPanel {
	...
	public PilotOptionalPanel() {
		...
		textField.setBounds(76, 34, 120, 20);
		add(textField);
		...
		textField_1.setBounds(76, 65, 120, 20);
		add(textField_1);
		
		textField_2 = new JTextField();
		textField_2.setColumns(10);
		textField_2.setBounds(76, 157, 120, 20);
		add(textField_2);
		...
		textField_3.setBounds(76, 126, 120, 20);
		add(textField_3);
		...
		textArea.setBounds(10, 220, 400, 75);
		add(textArea);
