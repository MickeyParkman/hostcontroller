...
public class Sailplane {
     ...
     * @param carryBallast                       can sailplane carry ballast
     * @param hasBallast                         is sailplane carrying ballast
     */
    public Sailplane(String number, String type1, String owners, String contactInfo,
                     ...
                     int maximumTension1, boolean carryBallast1){
        Number = number;
        type = type1;
        owner = owners;
    ...
    public Sailplane(String number, String type1,
                     int maximumGrossWeight1, int emptyWeight1, int indicatedStallSpeed1,
                     int maximumWinchingSpeed1, int maximumAllowableWeakLinkStrength1,
                     int maximumTension1, boolean carryBallast1, boolean hasBallast1){
        Number = number;
        type = type1;
        maximumGrossWeight = maximumGrossWeight1;
        emptyWeight= emptyWeight1;
        ...
        maximumAllowableWeakLinkStrength = maximumAllowableWeakLinkStrength1;
        carryBallast = carryBallast1;
        hasBallast = hasBallast1;
    }
    /**
     * This method allows user to mark if sailplane can carry ballast
     *
     *
     * @param carryBallast  the boolean check if sailplane can carry ballast
     *                       of the Sailplane object
     */
    public void setCarryBallast(boolean carryBallast1){
        carryBallast = carryBallast1;
    }
    
    /**
     * Returns an Sailplane object boolean if it can carry ballast.
     * @return      the boolean if it can carry ballast
     */
    public boolean getCarryBallast(){
        return carryBallast;
    }
    /**
     * This method allows user to mark if sailplane has ballast
     *
     * @param hasBallast  the boolean check if sailplane has ballast
     *                  of the Sailplane object
     */
    public void setHasBallast(boolean hasBallast1){
        if(carryBallast ==false)
        {
            hasBallast = false;
        }
        else{
    ...
    /**
     * Returns an Sailplane object boolean if has ballast ballast.
     * @return      the boolean if it has ballast
     */
    public boolean gethasBallast(){
        if(carryBallast ==false)
        {
            return false;
        }
