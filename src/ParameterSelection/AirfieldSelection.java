...
public class AirfieldSelection extends javax.swing.JPanel {
    ...
    private DefaultListModel<GliderPosition> positionsmdl = new DefaultListModel();
    ...
    GliderPosition[] positionsNewList = new GliderPosition[3];
                                                      ...
                                                      .addGroup(javax.swing.GroupLayout.Alignment.LEADING, layout.createSequentialGroup()
                                                                ...
                                                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                                                          ...
                                                                          .addGroup(layout.createSequentialGroup()
                                                                                    ...
                                                                                    .addGap(18, 18, 18)
                                                                                    .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                                                                              .addComponent(altitudeJTextField, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 110, javax.swing.GroupLayout.PREFERRED_SIZE)
                                                                                    ...
                                                                                    .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                                                                              .addGroup(layout.createSequentialGroup()
                                                                                                        ...
                                                                                                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                                                                                                  .addComponent(desgnatorlabel, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                                                                                                                  .addComponent(magneticVariationLabel))
                                                                                                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                                                                                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
    ...
    private void magneticVariationJTextFieldActionPerformed(java.awt.event.ActionEvent evt) {
        // TODO add your handling code here:
    }
    ...
    private void positionsInputJTextFieldKeyReleased(java.awt.event.KeyEvent evt) {
        // TODO add your handling code here:
        // Creates a string from a input
        ...
        // TODO Change from String specific to type Sailplane
        for(GliderPosition myObj : positionsNewList){
            if(myObj.toString().toUpperCase().startsWith(matchstring.toUpperCase()))
    ...
    private void runwayJListMouseClicked() {
        ...
        try {
            ...
            for(int i = 0; i < positionsNewList.length; i++){
                positionsNewList[i] = new GliderPosition();
    ...
    private void runwayInputJTextFieldKeyReleased(java.awt.event.KeyEvent evt) {                                                  
        // TODO add your handling code here:
        // Creates a string from a input
    ...
    private void positionsJListMouseClicked(java.awt.event.MouseEvent evt) {                                            
        ...
        try {
            ...
            if(positionsmdl.getSize() > 0){
                GliderPosition value = (GliderPosition) positionsJList.getSelectedValue();
    ...
    private void centerlineOffsetJTextFieldActionPerformed(java.awt.event.ActionEvent evt) {                                                           
        // TODO add your handling code here:
    }                                                          
    
    private void slopeJTextFieldActionPerformed(java.awt.event.ActionEvent evt) {                                                
        // TODO add your handling code here:
    }                                               
    
    private void maximumLengthJTextFieldActionPerformed(java.awt.event.ActionEvent evt) {                                                        
        // TODO add your handling code here:
    }                                                       
    
    private void magneticHeadingJTextFieldActionPerformed(java.awt.event.ActionEvent evt) {                                                          
        // TODO add your handling code here:
    }                                                         
    ...
    public GliderPosition getPositions() {
